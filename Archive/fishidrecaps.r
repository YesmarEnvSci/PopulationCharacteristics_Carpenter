...
# This file was used for the Year 2 report. It specifically looks at recap numbers for a couple of periods 
# in 2013 and 2014 to determine whether we were getting enough recaptures to justify a bull trout mark recapture.
# I moved it to archive because it is too specific to one year and the tag counts file does a more general job.
